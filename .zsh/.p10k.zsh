...
# Generated by Powerlevel10k configuration wizard on 2024-01-29 at 15:10 KST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh.
# Wizard options: compatible, ascii, lean, 24h time, 2 lines, dotted,
...
() {
  ...
  # Add an empty line before each prompt. (compact / sparse)
  ...
  function my_git_formatter() {
    ...
    if [[ -n ${VCS_STATUS_REMOTE_BRANCH:#$VCS_STATUS_LOCAL_BRANCH} ]]; then
      ...
      (( $#remote_branch > 15 )) && remote_branch[4,-10]=".."  # <-- this line
  ...
  typeset -g POWERLEVEL9K_VCS_MAX_INDEX_SIZE_DIRTY=25000
  ...
  # typeset -g POWERLEVEL9K_VCS_SVN_HOOKS=(vcs-detect-changes svn-detect-changes)
  ...
  # echo "scale = 2; (8.6 / 6) * 100" | bc  % (load average percent)
  ...
  typeset -g POWERLEVEL9K_IP_CONTENT_EXPANSION='$P9K_IP_INTERFACE $P9K_IP_IP${P9K_IP_RX_RATE:+ %70F<$P9K_IP_RX_RATE}${P9K_IP_TX_RATE:+ %215F>$P9K_IP_TX_RATE}'
