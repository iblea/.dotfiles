---
name: err
description: Analyze errors and warnings, then provide solutions. Use when encountering error messages, exceptions, or warnings that need diagnosis and resolution.
---
