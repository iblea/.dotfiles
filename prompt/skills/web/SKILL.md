---
name: web
description: Answer questions using external web searches. Use when up-to-date information is needed with source citations included in the response.
---
...
# SKILL behavior
- must use researcher agent unconditionally.
