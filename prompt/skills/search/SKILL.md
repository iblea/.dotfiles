---
name: search
description: Research topics via web search and create reliable reports. Use when gathering up-to-date information, cross-validating data, or searching academic papers with th/dis options.
---
