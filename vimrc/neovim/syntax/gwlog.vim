...
syntax match GwFDLog1 / FD -[0-9]*[ ,.]\{1\}/
syntax match GwFDLog1 / FD -[0-9]*$/
syntax match GwFDLog0 / FD [0-9]*[ ,.]\{1\}/
syntax match GwFDLog0 / FD [0-9]*$/

" syntax match GwFDLog1 / FD [0-9]*[13579]\{1\}[ ,.]\{1\}/
" syntax match GwFDLog1 / FD [0-9]*[02468]\{1\}[ ,.]\{1\}/
" syntax match GwFDLog1 / FD [0-9]*[13579]\{1\}$/
" syntax match GwFDLog1 / FD [0-9]*[02468]\{1\}$/
...
highlight GwFDLog0   ctermfg=213 guifg=#ff87ff
